...
LISTE_RUBRIQUES = [
    ...
    ("Page de connexion", ["connexion_image_fond", "connexion_adresse_exp", "connexion_texte_pas_codes", "connexion_creation_compte", "connexion_question_perso", "connexion_afficher_nom_organisateur"]),
    ("Page d'accueil", ["accueil_texte_bienvenue", "accueil_url_video", "accueil_titre_video"]),
    ("Page des renseignements", ["renseignements_afficher_page", "renseignements_intro", "renseignements_duree_certification", "renseignements_creation_individu",
                                 "validation_auto:famille_caisse", "validation_auto:individu_identite", "validation_auto:individu_coords",
                                 "validation_auto:individu_regimes_alimentaires", "validation_auto:individu_medecin", "validation_auto:individu_maladies"]),
    ...
    ("Page des réservations", ["reservations_afficher_page", "reservations_intro", "reservations_intro_planning", "reservations_adresse_exp", "reservations_blocage_impayes",
                               "reservations_ventilation_auto", "reservations_afficher_facturation", "reservations_afficher_forfaits"]),
