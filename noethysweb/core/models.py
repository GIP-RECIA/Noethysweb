...
LISTE_METHODES_TARIFS = [
    ...
    { "code": "qf_nbre_ind_inscrits_degr", "label":u"Montant dégressif en fonction du quotient familial et du nombre d'individus de la famille inscrits", "type": "unitaire", "nbre_lignes_max": None, "entete": "tranche", "champs": ("qf_min", "qf_max", "montant_enfant_1", "montant_enfant_2", "montant_enfant_3", "montant_enfant_4", "montant_enfant_5", "montant_enfant_6", ), "champs_obligatoires": ("qf_min", "qf_max", "montant_enfant_1"), "tarifs_compatibles": ("JOURN",) },
...
class Activite(models.Model):
    ...
    portail_reservations_limite = models.CharField(verbose_name="Date limite d'ajout d'une réservation", max_length=200, blank=True, null=True)
    portail_reservations_limite_suppr = models.CharField(verbose_name="Date limite de suppression d'une réservation", max_length=200, blank=True, null=True)
...
class PortailPeriode(models.Model):
    ...
    unites = models.ManyToManyField(Unite, verbose_name="Unités à afficher", related_name="periode_unites", blank=True)
