...
def GetMenuPrincipal(parametres_generaux=None, organisateur=None, user=None):
    ...
    menu_renseignements.Add(code="api_particulier_parametrer", titre="API Particulier", icone="file-text-o")
    ...
    # ------------------------------------ Aide ------------------------------------
    menu_aide = menu.Add(code="aide_accueil", titre="Aide", icone="support", toujours_afficher=parametres_generaux.get("aides_afficher_page_portailuser", False))
